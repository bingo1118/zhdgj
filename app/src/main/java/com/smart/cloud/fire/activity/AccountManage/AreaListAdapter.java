...
public class AreaListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AreaListAdapter(Context mContext, List<Area> listNormalSmoke,AccountEntity mAccount) {
    ...
    private void showPopupMenu(final View view, final Area entity) {
        ...
        // menu布局
        popupMenu.getMenuInflater().inflate(R.menu.menu_area, popupMenu.getMenu());
    ...
    private void unbindArea(final Area entity) {
        AlertDialog.Builder builder = new AlertDialog.Builder(mContext);
        builder.setTitle("提示");
        builder.setMessage("确定解绑该账号的该区域?");
