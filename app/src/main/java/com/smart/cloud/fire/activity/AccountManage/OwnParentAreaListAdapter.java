...
public class OwnParentAreaListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public OwnParentAreaListAdapter(Context mContext, List<Area> listNormalSmoke,AccountEntity mAccount) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            ((ItemViewHolder) holder).rela.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(mContext, OwnAreaListActivity.class);
    ...
    private void showPopupMenu(final View view, final Area entity) {
        ...
        // menu布局
        popupMenu.getMenuInflater().inflate(R.menu.menu_own_parent_area, popupMenu.getMenu());
    ...
    private void renameArea(final Area entity) {
        ...
        commit_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = ConstantValues.SERVER_IP_NEW + "renameParentArea?userId=" + mAccount.getUserId()
                        + "&areaName=" + name
    ...
    private void deleteArea(final Area entity) {
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                String url = ConstantValues.SERVER_IP_NEW + "deleteParentArea?userId=" + mAccount.getUserId()
                        + "&areaId=" + entity.getAreaId();
