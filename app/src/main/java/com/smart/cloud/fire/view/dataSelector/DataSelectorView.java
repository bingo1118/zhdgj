...
public abstract class DataSelectorView extends LinearLayout {

    public TextView editText;
    private ImageView imageView;
    private PopupWindow popupWindow = null;
    public ArrayList<BingoViewModel> dataList;
    ...
    public DataSelectorView(Context context) {
        this(context, null);
        // TODO Auto-generated constructor stub
    }

    public DataSelectorView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        // TODO Auto-generated constructor stub
    }

    public DataSelectorView(Context context, AttributeSet attrs, int defStyle) {
