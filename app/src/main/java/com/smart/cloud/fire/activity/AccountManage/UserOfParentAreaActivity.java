...
public class UserOfParentAreaActivity extends BaseActivity {
    ...
    private UserOfParentAreaAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_of_parent_area);
        ...
        list = new ArrayList<>();
        mAdapter = new UserOfParentAreaAdapter(mContext, list,mArea);
    ...
    private void getSubAccount(String areaId) {
        Observable mObservable = BasePresenter.apiStores1.getAccountOfParentArea(areaId);
    ...
    private void showPopupMenu(final View view) {
        ...
        // menu布局
        popupMenu.getMenuInflater().inflate(R.menu.menu_bind_account_of_p_area, popupMenu.getMenu());
