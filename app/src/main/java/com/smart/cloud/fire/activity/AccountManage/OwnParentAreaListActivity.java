...
public class OwnParentAreaListActivity extends AppCompatActivity {
    ...
    private OwnParentAreaListAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_own_parent_area_list);
    ...
    private void getOwnAreaList() {
        Observable mObservable = BasePresenter.apiStores1.getOwnParentAreaList(mAccount.getUserId(),mAccount.getPrivilege()+"");
        ...
        BasePresenter.addSubscription(mObservable, new SubscriberCallBack<>(new ApiCallback<AllAreaEntity>() {
            ...
            public void onSuccess(AllAreaEntity model) {
                ...
                if (result == 0) {
                    list = model.getList();
                    if(list.size()>0){
                        mAdapter = new OwnParentAreaListAdapter(mContext, list,mAccount);
    ...
    private void addArea() {
        ...
        commit_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = ConstantValues.SERVER_IP_NEW + "addParentArea?userId=" + mAccount.getUserId()
                        + "&areaName=" + name;
