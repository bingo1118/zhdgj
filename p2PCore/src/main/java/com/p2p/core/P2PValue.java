...
public class P2PValue {
	public static class AlarmType{
		...
		public static final int ALARM_TYPE_KEEP_SILENT=39;//39 silent
		public static final int ALARM_TYPE_SMOKE_ALARM=40;//40smoke
		public static final int ALARM_TYPE_GAS_ALARM=41;//41gas
		public static final int ALARM_TYPE_DOOR_MAGNET=42;//42door magnet
		public static final int ALARM_TYPE_TEMPTATURE=43;//43temprature
		public static final int ALARM_TYPE_HUMIDITY=44;//44humidity
		public static final int ALARM_TYPE_PIR_ALARM=45;//45pir
